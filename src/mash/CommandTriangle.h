...
public:
    ...
    {
        TriangleInput(const Sketch & sketchNew, uint64_t indexNew, const Sketch::Parameters & parametersNew, double maxDistanceNew, double maxPValueNew, bool emitJaccard_=false)
            :
            sketch(sketchNew),
            index(indexNew),
